...
//プレイヤー
    mgrap[0] = LoadGraph("/dev_hdd0/game/DRON30001/USRDIR/res/player.PNG");
//ブロック
    mgrap[1] = LoadGraph("/dev_hdd0/game/DRON30001/USRDIR/res/brock.PNG");
//アイテム
    mgrap[2] = LoadGraph("/dev_hdd0/game/DRON30001/USRDIR/res/item.PNG");
//敵
    mgrap[3] = LoadGraph("/dev_hdd0/game/DRON30001/USRDIR/res/teki.PNG");
//背景
    mgrap[4] = LoadGraph("/dev_hdd0/game/DRON30001/USRDIR/res/haikei.PNG");
//ブロック2
    mgrap[5] = LoadGraph("/dev_hdd0/game/DRON30001/USRDIR/res/brock2.PNG");
//おまけ
    mgrap[6] = LoadGraph("/dev_hdd0/game/DRON30001/USRDIR/res/omake.PNG");
//おまけ2
    mgrap[7] = LoadGraph("/dev_hdd0/game/DRON30001/USRDIR/res/omake2.PNG");
//タイトル
    mgrap[30] = LoadGraph("/dev_hdd0/game/DRON30001/USRDIR/res/syobon3.PNG");
...
//oto[2] = LoadSoundMem( "SE/1.mp3" ) ;
    otom[1] = LoadMusicMem("/dev_hdd0/game/DRON30001/USRDIR/BGM/field.ogg"); //50
    otom[2] = LoadMusicMem("/dev_hdd0/game/DRON30001/USRDIR/BGM/dungeon.ogg"); //40
    otom[3] = LoadMusicMem("/dev_hdd0/game/DRON30001/USRDIR/BGM/star4.ogg"); //50
    otom[4] = LoadMusicMem("/dev_hdd0/game/DRON30001/USRDIR/BGM/castle.ogg"); //50
    otom[5] = LoadMusicMem("/dev_hdd0/game/DRON30001/USRDIR/BGM/puyo.ogg"); //50
//otom[6]=LoadMusicMem( "BGM/last.ogg");
//ChangeVolumeSoundMem(50, otom[6]);

    oto[1] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/jump.ogg");
//oto[2] = LoadSoundMem("SE/brockcoin.ogg");
    oto[3] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/brockbreak.ogg");
    oto[4] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/coin.ogg");
    oto[5] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/humi.ogg");
    oto[6] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/koura.ogg");
    oto[7] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/dokan.ogg");
    oto[8] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/brockkinoko.ogg");
    oto[9] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/powerup.ogg");
    oto[10] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/kirra.ogg");
    oto[11] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/goal.ogg");
    oto[12] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/death.ogg");
    oto[13] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/Pswitch.ogg");
    oto[14] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/jumpBlock.ogg");
    oto[15] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/hintBlock.ogg");
    oto[16] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/4-clear.ogg");
    oto[17] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/allclear.ogg");
    oto[18] = LoadSoundMem("/dev_hdd0/game/DRON30001/USRDIR/SE/tekifire.ogg");
